  ...
  return (
    <div className="carousel w-full">
      <div id="slide1" className="carousel-item relative w-full">
        <div className="bg-gradient-to-r from-accent to-neutral  w-full flex md:flex-row flex-col-reverse justify-center items-center px-5">
      ...
      <div id="slide2" className="carousel-item relative w-full">
        <div className="bg-gradient-to-r from-secondary to-primary  w-full flex md:flex-row flex-col-reverse justify-center items-center px-5">
          <div className="lg:w-1/2">
